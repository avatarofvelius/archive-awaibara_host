  ...
  
  {
    ...
    engine.start = function(mapData, x, y)
    
      {
		...
		engine.tile.store(3, 'images/stair_down_2_alt.png');
		engine.tile.store(4, 'images/stair_down_2.png');
		engine.tile.store(5, 'images/tile_ground.png');
		engine.tile.store(6, 'images/fountain_1lted.png');
